...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("text-center flex justify-center flex-col lg:text-lg md:text-base text-sm mb-20") }, ...{ style: ({}) }, });
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ("@/assets/img/siam-kempinski-hotel-bangkok-logo.svg"), ...{ class: ("w-[160px] h-[160px]") }, ...{ style: ({}) }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ("@/assets/img/sindhorn-kempinski-hotel-bangkok-logo.svg"), ...{ class: ("w-[160px] h-[160px]") }, ...{ style: ({}) }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("flex justify-center mt-6 ") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ("@/assets/img/kempinski-logo.png"), ...{ class: ("w-[198px] h-[78px]") }, });
    if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
        ...
        __VLS_styleScopedClasses['flex'];
        __VLS_styleScopedClasses['justify-center'];
        __VLS_styleScopedClasses['w-[160px]'];
        __VLS_styleScopedClasses['h-[160px]'];
        __VLS_styleScopedClasses['w-[160px]'];
        __VLS_styleScopedClasses['h-[160px]'];
        __VLS_styleScopedClasses['flex'];
        __VLS_styleScopedClasses['justify-center'];
        __VLS_styleScopedClasses['mt-6'];
        __VLS_styleScopedClasses['w-[198px]'];
        __VLS_styleScopedClasses['h-[78px]'];
    }
    var __VLS_slots;
    return __VLS_slots;
