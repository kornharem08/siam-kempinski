...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ("@/assets/img/siam-kempinski-hotel-bangkok-logo.svg"), ...{ class: ("lg:w-[160px] lg:h-[160px] w-[60px] h-[60px]") }, ...{ style: ({}) }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ("@/assets/img/sindhorn-kempinski-hotel-bangkok-logo.svg"), ...{ class: ("lg:w-[160px] lg:h-[160px] w-[60px] h-[60px]") }, ...{ style: ({}) }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("flex justify-center mt-6 ") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ("@/assets/img/kempinski-logo.png"), ...{ class: ("lg:w-[198px] lg:h-[78px] w-[80px] h-[30px]") }, });
